...
class JobOffer(djmodels.Model):
    employer = djmodels.ForeignKey(Player, related_name='offer_made', on_delete=models.CASCADE)
...
class Task(djmodels.Model):
    ...
    player = djmodels.ForeignKey(to=Player, related_name='tasks', on_delete=models.CASCADE)
